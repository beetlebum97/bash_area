...
function mostrar_menu {
    ...
    echo -e "${Morado}┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫${NC}"
    echo -e "${Morado}┃ ┃${NC}"
    echo -e "${Morado}┃ ${Amarillo}${Negrita}📊 ANÁLISIS POR TAMAÑO${NC} ${Morado}┃${NC}"
    echo -e "${Morado}┃ ${NC} ${Amarillo}[1]${NC} Directorios por tamaño (mayor a menor) ${Morado}┃${NC}"
    echo -e "${Morado}┃ ${NC} ${Amarillo}[2]${NC} Archivos por tamaño (mayor a menor) ${Morado}┃${NC}"
    echo -e "${Morado}┃ ┃${NC}"
    echo -e "${Morado}┃ ${AzulClaro}${Negrita}🕒 ANÁLISIS POR FECHA${NC} ${Morado}┃${NC}"
    echo -e "${Morado}┃ ${NC} ${CianClaro}[3]${NC} Directorios por fecha (más recientes) ${Morado}┃${NC}"
    echo -e "${Morado}┃ ${NC} ${CianClaro}[4]${NC} Archivos por fecha (más recientes) ${Morado}┃${NC}"
    echo -e "${Morado}┃ ┃${NC}"
    echo -e "${Morado}┃ ${Verde}${Negrita}🔍 ANÁLISIS COMBINADO${NC} ${Morado}┃${NC}"
    echo -e "${Morado}┃ ${NC} ${VerdeClaro}[5]${NC} Resumen del directorio actual ${Morado}┃${NC}"
    echo -e "${Morado}┃ ${NC} ${VerdeClaro}[6]${NC} Archivos grandes recientes (tamaño+fecha) ${Morado}┃${NC}"
    echo -e "${Morado}┃ ┃${NC}"
    echo -e "${Morado}┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫${NC}"
    echo -e "${Morado}┃ ${RojoClaro}${Negrita}[7] 🚪 Salir${NC} ${Morado}┃${NC}"
    echo -e "${Morado}┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛${NC}"
    echo ""
}
